...
var OpCodes = map[uint8]OpEntry{
	...
	0x49: {"LD C, C			", 4, func(gb *GbCpu) { gb.Reg.C = gb.Reg.C; gb.Reg.PC++ }},
	...
	0x52: {"LD D, D			", 4, func(gb *GbCpu) { gb.Reg.D = gb.Reg.D; gb.Reg.PC++ }},
	...
	0x5B: {"LD E, E			", 4, func(gb *GbCpu) { gb.Reg.E = gb.Reg.E; gb.Reg.PC++ }},
	...
	0x64: {"LD H, H			", 4, func(gb *GbCpu) { gb.Reg.H = gb.Reg.H; gb.Reg.PC++ }},
	0x65: {"LD H, L			", 4, func(gb *GbCpu) { gb.Reg.H = gb.Reg.L; gb.Reg.PC++ }},
	...
	0x6C: {"LD L, H			", 4, func(gb *GbCpu) { gb.Reg.L = gb.Reg.H; gb.Reg.PC++ }},
	0x6D: {"LD L, L			", 4, func(gb *GbCpu) { gb.Reg.L = gb.Reg.L; gb.Reg.PC++ }},
	...
	0x76: {"HALT			", 4, func(gb *GbCpu) { gb.Halted = true; gb.Reg.PC++ }},
	...
	0x7F: {"LD A, A			", 4, func(gb *GbCpu) { gb.Reg.A = gb.Reg.A; gb.Reg.PC++ }},
	...
	0x8F: {"ADC A			", 4, func(gb *GbCpu) { Do_Adc_88(gb, &gb.Reg.A, gb.Reg.A) }},
	...
	0xC7: {"RST 00			", 16, func(gb *GbCpu) { Op_Rst(gb, 0x00) }},
	0xC9: {"RET				", 16, Op_RET},
	...
	0xE7: {"RST 20			", 16, func(gb *GbCpu) { Op_Rst(gb, 0x20) }},
	...
	0xF7: {"RST 30			", 16, func(gb *GbCpu) { Op_Rst(gb, 0x30) }},
